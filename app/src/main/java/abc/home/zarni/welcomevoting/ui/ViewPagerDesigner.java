package abc.home.zarni.welcomevoting.ui;
...
public class ViewPagerDesigner  extends ViewPager implements ViewPager.PageTransformer {
    ...
    public ViewPagerDesigner(Context context) {
        this(context, null);
    }

    public ViewPagerDesigner(Context context, AttributeSet attrs) {
        super(context, attrs);
